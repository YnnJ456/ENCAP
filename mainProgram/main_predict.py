from userPackage.Package_TOPTTCA import TOPTTCA_Predict
...
toObj = TOPTTCA_Predict(model_use=model_use, pathDict=pathDict)
toObj.loadData(inputDataList=inputPathList)
toObj.featureEncode()
toObj.doPredict()
